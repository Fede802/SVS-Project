...
for v in world.get_actors().filter('vehicle.*'):
    v.destroy()
ego_vehicle = carla_utility.spawn_veichle_bp_at(world=world, vehicle='vehicle.tesla.cybertruck', spawn_point=carla.Transform(carla.Location(x=-70, y=27, z=5)))
...
ego_vehicle2 = carla_utility.spawn_veichle_bp_at(world=world, vehicle='vehicle.tesla.cybertruck', spawn_point=carla.Transform(carla.Location(x=-60, y=27, z=5)))
time.sleep(2)
